...
public interface PurchaseOrderDetailMapper {
     ...
     *
     * @param id 主键ID
     * @return 匹配的采购订单明细表实体；不存在时返回 null
     */
     ...
     * @return 匹配的采购订单明细表列表
     */
    List<PurchaseOrderDetail> selectByCondition(PurchaseOrderDetail entity);
     ...
     * @return 匹配的记录数量
     */
    Long countByCondition(PurchaseOrderDetail entity);
     ...
     * @return 受影响的记录条数
     */
    int updateById(PurchaseOrderDetail entity);
